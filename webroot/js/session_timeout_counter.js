  ...
  if (distance < 0) {
    ...
    if(sessionLogoutStatus == 0){
      $.ajax({
        ...
        data: {'action':'session_logout','session_token':sessionToken,'session_usertype':sessionUsertype,'session_username':sessionUsername,'session_support_team_login':sessionSupportTeamLogin},
