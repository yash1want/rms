...
$(document).ready(function () {
    ...
    $("#frmDailyAverage").validate({
        rules: {
            ...
            ,
            "F_Open[TOTAL_MALE_DIRECT]": {
                roundOff1: true,
                required: true,
                number: true
                        //        checkDirectTotalMale:true
            },
            "F_Open[TOTAL_FEMALE_DIRECT]": {
                roundOff1: true,
                required: true,
                number: true
                        //        checkDirectTotalFemale:true        
            },
            "F_Open[TOTAL_MALE_CONTRACT]": {
                roundOff1: true,
                required: true,
                number: true
                        //        checkcontractTotalMale:true
            },
            "F_Open[TOTAL_FEMALE_CONTRACT]": {
                roundOff1: true,
                required: true,
                number: true
    ...
    salesAndDispatchValidation: function () {
        $(document).ready(function () {
            ...
            $.validator.addMethod("bMaxlength", $.validator.methods.maxlength,
                    $.format("Max. length allowed is 13,3 digits"));
            $.validator.addMethod("bMax", $.validator.methods.max,
                    $.format("Max. entered value length must be less then or equal to 13,3 digits"));
