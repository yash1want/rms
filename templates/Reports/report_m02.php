<?php if (!empty($records)) { ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <h4 class="tHeadFont" id='heading1'>Report M02A - Grade wise Production, Grade wise Dispatch, Grade wise Ex-mine Price, Opening-Closing Stock, Sale Quantity & Value (For Iron Ore and Chromite)</h4>
                        ...
                        <div class="card-body" id="avb">
							...
							<?php } else { ?>
                                ...
                                <table class="table table-striped table-hover table-bordered compact" border="1" id="noDatatable">
                                    <thead class="tableHead">
										<tr>
											<th colspan="21" class="noDisplay" align="left">Report M02A - Grade wise Production, Grade wise Dispatch, Grade wise Ex-mine Price, Opening-Closing Stock, Sale Quantity & Value (For Iron Ore and Chromite) Date : <?php echo 'From ' . $showDate; ?> </th>
										</tr>
                                        <tr>
                                            <th>#</th>
                                            <th>Month</th>
