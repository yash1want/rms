  ...
  <div class="tab-pane tabs-animation fade active show" id="tab-content-1" role="tabpanel">
    <div class="main-card mb-3 card">
      <div class="card-body">
        ...
        <h4 class="card-title text-white reportHeadingMain">Reports List</h4>
          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody class="tBodyCenter">
              <tr>
                ...
                <td>REPORT-M01A</td>
                <td>
                  <a href="<?= $this->Url->build(['action' => 'monthly-filter', '?' => ['title' => 'report-M01a']]) ?>" class="reportLink">Grade wise ROM Dispatch, ROM Ex-Mine Price, Sale Quantity and Value (For Iron Ore and Chromite)</a>
                </td>
              </tr>
