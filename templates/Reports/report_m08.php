<?php if (!empty($records)) { ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <h4 class="tHeadFont" id='heading1'>Report M08 - Precious & Semi Precious Stone ROM Production Details( Form F3)</h4>
							...
							<?php } else { ?>
								...
								<div class="table-responsive">
									<table class="table table-striped table-hover table-bordered compact" border="1" id="noDatatable">
										<thead class="tableHead">
											<tr>
												<th colspan="14" class="noDisplay" align="left">Report M08 - Precious & Semi Precious Stone ROM Production Details( Form F3)  Date : <?php echo 'From ' . $showDate; ?></th>
											</tr>
											<tr>
												<th rowspan="2"># </th>
												<th rowspan="2">Month</th>
