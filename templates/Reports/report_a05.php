<?php if (!empty($records)) { ?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <h4 class="tHeadFont" id="heading1">Report A05 - Dispatch Details Ore/Concentrates</h4>
                        ...
                        <div class="card-body" id="avb">
							...
							<div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered compact" border="1" id="noDatatable">
                                    <thead class="tableHead">
										<tr>
											<th colspan="19" class="noDisplay" align="left">Report A05 - Dispatch Details Ore/Concentrates  Year : <?php echo $showDate; ?></th>
										</tr>
                                        <tr>
                                            <th rowspan="2">#</th>
                                            <th rowspan="2">Year</th>
