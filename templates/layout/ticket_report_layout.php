...
<head>
	...
	<?php
	echo $this->Html->css('report-js-css/jquery.dataTables.min.css?version=' . $version);
	echo $this->Html->css('report-js-css/buttons.dataTables.min.css?version=' . $version);
	
	echo $this->Html->script('report-js-css/jquery.js?version=' . $version);
	echo $this->Html->script('report-js-css/jquery.dataTables.min.js?version=' . $version);
	echo $this->Html->script('report-js-css/dataTables.buttons.min.js?version=' . $version);
	echo $this->Html->script('report-js-css/jszip.min.js?version=' . $version);
	echo $this->Html->script('report-js-css/pdfmake.min.js?version=' . $version);
	echo $this->Html->script('report-js-css/vfs_fonts.js?version=' . $version);
	echo $this->Html->script('report-js-css/buttons.html5.min.js?version=' . $version);
	echo $this->Html->script('report-js-css/buttons.print.min.js?version=' . $version);
	...
	echo $this->Html->script('reports.js?version=' . $version);
