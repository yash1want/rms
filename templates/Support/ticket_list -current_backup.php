						...
						<tr>                       
                    			...
                    			<td>
									...
									<?php 
										...
										if($row['status']=='Pending')
										{
	                    					echo "<h6><span class='badge badge-warning font-weight-bold'>Pending from ".$count." day</span></h6>";
	                    					/*echo "<span class='badge badge-light' >Pending from <span class='badge badge-primary font-weight-bold '> ".$count." </span> day</span>";*/
	                    				}
	                    				elseif($row['status']=='Inprocess')
	                    				{
	                    					echo "<h6><span class='badge badge-info font-weight-bold '>Inprocess from ".$count." day</span></h6>";
	                    				}
	                    				else
	                    				{
	                    					echo "<h6><span class='badge badge-success  font-weight-bold text-black'>Closed from ".$count." day </span></h6>";
	                    				}
