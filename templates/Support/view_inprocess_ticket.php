		...
		<div class="card-body ">
			...
			<div class="row"><!-- <div class="col-md-12 form-row"> -->
		          ...
		          <div class="row">
		          	<div class="col-md-1">&nbsp;</div>
			          	<div class="col-md-10">
			          		<label>Ticket Related<span class="cRed"></span></label>
			          		<div class='card-body borderClass'>
					          	...
					          	<div class="row" id="show_resolve_form">
				           		...
				           		<div class="row" id="show_resolve_form">
				                	...
				                	<div class="col-md-12 mb-4">
					                    ...
					                    <?php echo $this->Form->control('description', array('type' => 'textarea','class'=>'form-control','style' => 'height:100px;','value'=>'','id'=>'description','maxlength'=>'10000','placeholder'=>'Your reply type here....','label'=>false)); ?>               
					                    <div id="description_error" class="text-danger"></div>
				            		</div>
				             	</div>
				             	<!--===============================Start Add  more row ===============================-->
				             	<div class="row">
								<div class="col-md-12 mb-4 " id='ticket-table'>
...
<?php echo $this->Html->script('support/support_page.js?version='.$version);?>
