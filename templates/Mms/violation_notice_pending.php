...
/**
 * Created Violation Notice List by Shweta Apale on 31-01-2022
 */
?>
<div class="main-card card fcard mb-1 mt-n3">
    <div class="card-body pt-2 pb-3">
        ...
        <?= $this->Form->create(null, [
            'name' => 'violationNoticePending',
            'url' => [
                'controller' => 'mms',
                'action' => 'violation-notice-pending',
            ]
        ]); ?>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <?= $this->Form->create(null, [
                ...
                'url' => [
                    'controller' => 'mms',
                    'action' => 'violation-notice-pending-display',
                ]
            ]); ?>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <input type="checkbox" value="<?php echo $record['MineCode']; ?>" name="check_array[]" id="check_array">
