...
/**
 * Created Violation Notice List For L & Mby Shweta Apale
 */
?>
<div class="main-card card fcard mb-1 mt-n3">
    <div class="card-body pt-2 pb-3">
        ...
        <?= $this->Form->create(null, [
            ...
            'url' => [
                'controller' => 'mms',
                'action' => 'violation-notice-list-l-m',
            ]
        ]); ?>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <?= $this->Form->create(null, [
                ...
                'url' => [
                    'controller' => 'mms',
                    'action' => 'violation-notice-display-l-m',
                ]
            ]); ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                if (in_array($record['applicantId'], $applicant_id_array)) {
                                ?>
