...
<div class="main-card card fcard mt-n3">
    <div class="card-body p-1 page-heading text-white">        
            <h5 class="text-center font-weight-bold m-0">Add Menus</h5> 
    </div>
</div>
            ...
            <div class="col-md-6">
            	...
            	<div class="col-md-12 mb-3 ">
					...
					<div class="col-md-9">
						<?php
							...
							$attributes=array('legend'=>false, 'id'=>'link_type', 'value'=>'page','class'=>'m1');
            	...
            	<div class="col-md-12 mb-3 "> 
					...
					<?php
						...
						$attributes=array('legend'=>false, 'id'=>'position', 'value'=>'top','class'=>'m1');
               ...
               <div class="card-footer cardFooterBackground">
               	<?php echo $this->Form->submit('Create', array('name'=>'create','class'=>'form-control btn btn-success pl-4 pr-4 font-weight-bold','id'=>'create_btn','label'=>false)); ?>
