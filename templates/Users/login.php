		  ...
		  <div class="container1 login-page-background">
			...
			<div class="form-group ">
				...
				<div class="input-group">
					...
					<?php echo $this->Form->control('username', array('class'=>'form-control login-input-fields', 'autocomplete'=>'off', 'placeholder'=>$userlogintxt['placeholder'], 'id'=>'username','label'=>false,'templates'=>array('inputContainer'=>'{{content}}'))); ?>								
				</div>
		    ...
		    <?php echo $this->Form->control('tkn', array('label'=>'', 'id'=>'salt_value', 'type'=>'hidden', 'value'=>$tkn)); ?>
			...
			<span class="forgot_link">
				<?php 
					if(isset($_SESSION) && $_SESSION['loginusertype'] != 'primaryuser'){
						echo $this->Html->link('Forgot Password?', '/users/'.$current_ctrl.'ForgotPassword', array('class'=>'login_watag')); 
					}else{
						echo 'Please forgot your password from ibmreg.nic.in';
					}	
				?>
			</span>
