...
echo '<a href="../reportsnext/monthly-filter?title=reportm35" class="btn btn-primary backBtn mb-2">Back</a>';
...
echo '<tbody class="bg-secondary text-white"><tr>
        ...
        <tr>
            ...
            <td class="HEADER3" id="reportname">M16</td>
        </tr>        
    </tbody>';
echo '<tbody>';
