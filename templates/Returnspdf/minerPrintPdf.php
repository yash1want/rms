                ...
                <td align="center">
                    <div id="name_address">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<!-- Added on 20-06-2023 by Shweta Apale start -->
                            <tr>
                                <td align="center">
                                    <div id="name_address">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" valign="top" class="f_s_9">
                                                    <table width="100%" border="0.5" cellpadding="4" cellspacing="0" bordercolor="#E5D0BD" style="border-collapse:collapse" nobr="true">
                                                        <tr>
                                                            <td align="left" class="f_s_10 f_b">Uploaded Document</td>
                                                        </tr>
                                                        <tr>
                                                            <?php
                                                            $excel1 =  explode('/', $owner['profile_pdf']); //To get excel name
                                                            $excel_arr_no1 = count($excel1) - 1;
                                                            $profile_pdf = substr($excel1[$excel_arr_no1], 23);

                                                            $excel2 =  explode('/', $owner['profile_kml']); //To get excel name
                                                            $excel_arr_no2 = count($excel2) - 1;
                                                            $profile_kml = substr($excel2[$excel_arr_no2], 23);
                                                            ?>
                                                            <td align="left" class="lable-text">Upload PMCP Table in Excel: &nbsp;&nbsp;
                                                                <a href="<?php echo $owner['profile_pdf']; ?>" target="_blank"><?php echo $profile_pdf; ?></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="lable-text">Upload UAV Survey (KML/KMZ File) : &nbsp;
                                                                <a href="<?php echo $owner['profile_kml']; ?>" target="_blank"> <?php echo $profile_kml; ?></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <div id="geology_reserves_subgrade">
                                ...
                                <table width="100%" border="0.5" cellpadding="4" cellspacing="0" bordercolor="#E5D0BD" style="border-collapse:collapse;" class="f_s_9">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><?php echo $resTotal['begin'] = number_format((float)$reserves[$min_un]['proved_begin'] + (float)$reserves[$min_un]['probable_first_begin'] + (float)$reserves[$min_un]['probable_sec_begin'], 2); ?>
                                        </td>
                                        <td><?php echo $resTotal['during'] = number_format((float)$reserves[$min_un]['proved_assessed_during'] + (float)$reserves[$min_un]['probable_first_assessed_during'] + (float)$reserves[$min_un]['probable_sec_assessed_during'], 2); ?>
                                        </td>
                                        <td><?php echo $resTotal['depletion'] = number_format((float)$reserves[$min_un]['proved_depletion'] + (float)$reserves[$min_un]['probable_first_depletion'] + (float)$reserves[$min_un]['probable_sec_depletion'], 2); ?>
                                        </td>
                                        <td><?php echo $resTotal['balance'] = number_format((float)$reserves[$min_un]['proved_balance'] + (float)$reserves[$min_un]['probable_first_balance'] + (float)$reserves[$min_un]['probable_sec_balance'], 2); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><?php echo $totRemRes['begin'] = number_format((float)$reserves[$min_un]['feasibility_begin'] + (float)$reserves[$min_un]['prefeasibility_first_begin'] + (float)$reserves[$min_un]['prefeasibility_sec_begin'] + (float)$reserves[$min_un]['measured_begin'] + (float)$reserves[$min_un]['indicated_begin'] + (float)$reserves[$min_un]['inferred_begin'] + (float)$reserves[$min_un]['reconnaissance_begin'], 2); ?>
                                        </td>
                                        <td><?php echo $totRemRes['during'] = number_format((float)$reserves[$min_un]['feasibility_assessed_during'] + (float)$reserves[$min_un]['prefeasibility_first_assessed_during'] + (float)$reserves[$min_un]['prefeasibility_sec_assessed_during'] + (float)$reserves[$min_un]['measured_assessed_during'] + (float)$reserves[$min_un]['indicated_assessed_during'] + (float)$reserves[$min_un]['inferred_assessed_during'] + (float)$reserves[$min_un]['reconnaissance_assessed_during'], 2); ?>
                                        </td>
                                        <td><?php echo $totRemRes['depletion'] = number_format((float)$reserves[$min_un]['feasibility_depletion'] + (float)$reserves[$min_un]['prefeasibility_first_depletion'] + (float)$reserves[$min_un]['prefeasibility_sec_depletion'] + (float)$reserves[$min_un]['measured_sec_depletion'] + (float)$reserves[$min_un]['indicated_sec_depletion'] + (float)$reserves[$min_un]['inferred_sec_depletion'] + (float)$reserves[$min_un]['reconnaissance_sec_depletion'], 2); ?>
                                        </td>
                                        <td><?php echo $totRemRes['balance'] = number_format((float)$reserves[$min_un]['feasibility_balance'] + (float)$reserves[$min_un]['prefeasibility_first_balance'] + (float)$reserves[$min_un]['prefeasibility_sec_balance'] + (float)$reserves[$min_un]['measured_sec_balance'] + (float)$reserves[$min_un]['indicated_sec_balance'] + (float)$reserves[$min_un]['inferred_sec_balance'] + (float)$reserves[$min_un]['reconnaissance_sec_balance'], 2); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!--<td align="left"><?php //echo $label['geology_reserves_subgrade'][18]; ?></td>
                                        <td></td>
                                        <td><?php //echo number_format($resTotal['begin'] + $totRemRes['begin'], 2); ?>
                                        </td>
                                        <td><?php //echo number_format($resTotal['during'] + $totRemRes['during'], 2); ?>
                                        </td>
                                        <td><?php //echo number_format($resTotal['depletion'] + $totRemRes['depletion'], 2); ?>
                                        </td>
                                        <td><?php //echo number_format($resTotal['balance'] + $totRemRes['balance'], 2); ?>
                                        </td> -->
										<!-- Added str_replace() on 16-06-2023 by Shweta Apale -->
										<td align="left"><?php echo $label['geology_reserves_subgrade'][18]; ?></td>
                                        <td></td>
                                        <td><?php echo number_format(str_replace( ',', '',$resTotal['begin']) + str_replace( ',', '',$totRemRes['begin']), 2); ?>
                                        </td>
                                        <td><?php echo number_format(str_replace( ',', '',$resTotal['during']) + str_replace( ',', '',$totRemRes['during']), 2); ?>
                                        </td>
                                        <td><?php echo number_format(str_replace( ',', '',$resTotal['depletion']) + str_replace( ',', '',$totRemRes['depletion']), 2); ?>
                                        </td>
                                        <td><?php echo number_format(str_replace( ',', '',$resTotal['balance']) + str_replace( ',', '',$totRemRes['balance']), 2); ?>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr>
                        <td align="left">
                            <div id="geology_part_six">
                                <table cellpadding="2" cellspacing="0" border="#000" bordercolor="#E5D0BD" class="sec_tit">
                    ...
                    <td align="left" valign="top">
                        <table width="100%" border="0.5" cellpadding="4" cellspacing="0" bordercolor="#E5D0BD" style="border-collapse:collapse;" nobr="true" class="f_s_9">
                            ...
                            <tr height="60">
                                ...
                                <td align="center"><?php echo htmlentities($deductDetail[$minLow]['trans_remark'],ENT_QUOTES); ?></td>
                            </tr>
                            <tr height="60">
                ...
                <tr>
                    <td align="left" valign="top">
                                ...
                                <?php
                                    ...
                                    foreach ($mainGrade as $mainGradeKey => $mainGradeVal) {
                                        ...
                                        if($showGrade == true){
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="<?php echo ($formNo == 3 && $i > 6) ? 2 : ''; ?>" >
                                                    <?php 
                        ...
                        <?php if($ironSubMin == '/hematite'){ ?>
                            <table width="100%" cellpadding="2" cellspacing="0" bordercolor="#E5D0BD" class="foot_note">
                                <tr align="center"><td><?php echo $label['gradewise_prod']['note_2']; ?></td></tr>
                            </table>
                        <?php } ?>
                    </td>
                </tr>
