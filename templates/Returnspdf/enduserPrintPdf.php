                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data['genp']['addressDetails'][0]['mcmcd_nameofplant'] ? $data['genp']['addressDetails'][0]['mcmcd_nameofplant'] . ",<br/>" : ""; ?><?php echo $data['genp']['addressDetails'][0]['mcmd_village'] ? $data['genp']['addressDetails'][0]['mcmd_village'] . ",<br/>" : ""; ?>
                                                    ...
                                                    <?php echo (isset($data['genp']['regionAndDistrictName'][0]['district_name'])) ? $data['genp']['regionAndDistrictName'][0]['district_name'] . ",<br/>" : (isset($data['genp']['regionAndDistrictName']['district_name']) ? $data['genp']['regionAndDistrictName']['district_name'] . ",<br/>" : (isset($data['genp']['regionAndDistrictName'][0][1]) ? $data['genp']['regionAndDistrictName'][0][1] . ",<br/>" : "")); ?>
                                        ...
                                        <table width="100%" border="0.5" class="f_s_9" cellpadding="4" cellspacing="0" nobr="true">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <?php echo $data['isi']['current_expansion_prog']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <?php 
                                                    ...
                                                    for ($i = 1; $i <= $count; $i++) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($rmc['rawmat_physpe_'.$i]); ?></td>
                                                            <td><?php echo htmlentities($rmc['rawmat_chespe_'.$i]); ?></td>
