    ...
    <table class="table">
        <tbody>
                ...
                <td align="center">
                    <div id="details_maines">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
                            <tr><td></td></tr>
                            <tr>
                                <td align="center"><span style="margin-left:50px"><strong>Part - I</strong></span></td>
                            </tr>
                            <tr>
                                <td align="center"><span style="margin-left:50px"><strong>(General and Labour)</strong></span></td>
                            </tr>
                            <tr><td></td></tr>
                            <tr>
           ...
           <tr>
            ...
            ?>
            <tr>
                <td align="center"><span style="margin-left:50px"><strong><?php echo $label['rom_stocks']['part']; ?></strong></span></td>
            </tr>
            <tr><td></td></tr>
