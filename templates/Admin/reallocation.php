<div class="main-card card fcard mt-n3">
    ...
    <a href="<?php echo $this->getRequest()->getAttribute('webroot');?>admin/allocation-type/reallocate" class="btn btn-light float-left"> Back <a>        
            <h5 class="text-center font-weight-bold m-0">Reallocation</h5> 
    </div>
</div>
...
<input type="hidden" id="allocationtype" value="reallocate">
        ...
        <div class="row pb-4">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-12 pt-5">
                    <label></label>
                    <?php echo $this->Form->control('Reallocate', array('type'=>'button', 'class'=>'btn btn-success', 'id'=>'allocate', 'label'=>false)); ?>
                </div>
            </div>
                    ...
                    <table class="mb-0 table table-striped " id="unallocateRecord">
                        <thead class="bg-dark text-white">
                            <tr>
                                ...
                                <th class="p-1 border-right-1 border-white">Allocated Supervisor Id</th>
                                <th class="p-1 border-right-1 border-white">Allocated Primary User Id</th>
                            </tr>
                        </thead>
                    </table>
                    <?php $this->Form->end() ?>  
