        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row header_new">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 header_new_md">
                <div class="w_f_c m-auto font_sans">
                    ...
                    <div class="header_md_title_main">SUPPORT MODULE</div>
                </div>
            </div>
...
<div class="app-header header-shadow bg-dark header-text-light">
    <div class="app-header__logo">
        <div class="logo-src"><span class="u-logo-text">SUPPORT</span></div>
    ...
    <div class="app-header__content">
        <div class="app-header-left">
            <ul class="header-menu nav">
                ...
                <li class="nav-item">
                        <div class="btn-group dropdown nav-link">
                            <!-- <button type="button"  class="mb-2 mr-2 btn btn-dark"><i class="nav-link-icon fa fa-database"> </i> <a href="<//?php echo $this->request->getAttribute('webroot'); ?>support-mod/ticket-report-list"> Reports </a></button> -->

                            <button type="button"  class="mb-2 mr-2 btn btn-dark"><i class="nav-link-icon fa fa-database"> </i> <a href="<?= $this->Url->build(['action' => 'all-status-filter', '?' => ['title' => 'report-filter']]) ?>"> Reports </a></button>
                        </div>
                </li>
                <?php } ?>
            </ul>        
        ...
        <div class="app-header-right">
            ...
            <div id="session_timer">
                ...
                <?php echo $this->Form->control('session_timer_id', array('type'=>'hidden', 'id'=>'session_timer_id', 'value'=>isset($_SESSION['login_session']))); ?>
                ...
                <?php echo $this->Form->control('session_usertype', array('type'=>'hidden', 'id'=>'session_usertype', 'value'=>isset($_SESSION['loginusertype']))); ?>
                <?php echo $this->Form->control('session_username', array('type'=>'hidden', 'id'=>'session_username', 'value'=>isset($_SESSION['username']))); ?>
                <?php echo $this->Form->control('session_timer_status', array('type'=>'hidden', 'id'=>'session_timer_status', 'value'=>0)); ?>
                <?php echo $this->Form->control('session_support_team_login', array('type'=>'hidden', 'id'=>'session_support_team_login', 'value'=>isset($_SESSION['support_team_login']))); ?>
            </div>
                            ...
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                   <!--  <a href="<//?php echo $this->request->getAttribute('webroot')?>auth/profile" class="dropdown-item">
                                    ...
                                    <!-- Support User Log -->
                                    <?php echo $this->Html->link('<i class="fa fa-clock mr-2"></i>Support Logs','/support-mod/logs',array('class'=>'dropdown-item','escapeTitle'=>false)); ?>
                                    <div tabindex="-1" class="dropdown-divider"></div>
                                    <!-- Logout -->
                                    <?php 
                                    $loginusertype = $this->getRequest()->getSession()->read("loginusertype");
                                    $loginuser_name = $this->getRequest()->getSession()->read("user_name");
                                    $loginuser_designation = $this->getRequest()->getSession()->read("designation");
                                    $loginuser_role_id = $this->getRequest()->getSession()->read("role_id");
                                    echo $this->Html->link('<i class="fa fa-power-off mr-2"></i>Logout', '/support-mod/logout/'.$loginusertype, array('class'=>'dropdown-item', 'escapeTitle'=>false)); ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-subheading text-center">
                                ...
                                switch($loginusertype) {
                                    case 'supportuser':
                                        ...
                                        break;
                                    default:
                                        $headerUserType = 'SUPERADMIN';
                                }
                                echo $headerUserType;
                                ?> -->
                                <?php 
                                echo "<label>( ".$loginuser_designation." )</label>";
                                ?>
                            </div>
                        </div>
                        <div class="widget-content-right header-user-info ml-3">
                            <?php echo $this->Html->link('<i class="fa text-white fa-power-off pr-1 pl-1"></i>', '/support-mod/logout/'.$loginusertype, array('class'=>'btn-shadow p-1 btn btn-dark btn-sm', 'escapeTitle'=>false)); ?>
                        </div>
                    </div>
                </div>
            </div>        
