...
<h4 class="card-title bg-primary text-white masterHeading">Add New Mineral Work</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?= $this->Form->control('mine_code', [
                ...
                'title' => 'Only letters, numbers are allwoed not more than 20 characters'
            ]); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?= $this->Form->control('proportion', [
                'class' => 'form-control cvOn cvFloat cvNotReq',
                'label' => false,
                'pattern' => '[0-9.]{1,20}',
                'cvfloat' => '9999.99',
