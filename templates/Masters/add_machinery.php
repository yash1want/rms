...
<h4 class="card-title bg-primary text-white masterHeading">Add New Machinery</h4>
<?= $this->Form->create(null, ['id' => 'machineryForm', 'class' => 'master_form']); ?>
<div class="col-md-2"></div>
<div class="col-md-8">
    <div class="row">
        <div class="col-md-6">
            <label for="machinery-code" class="labelForm"><span class="compulsoryField">*</span> Machinery Code</label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="machinery-name" class="labelForm"><span class="compulsoryField">*</span> Machinery Name</label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="capacity" class="labelForm">Capacity Unit</label>
        </div>
        <div class="col-md-6">
