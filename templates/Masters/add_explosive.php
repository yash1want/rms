...
<h4 class="card-title bg-primary text-white masterHeading">Add New Explosive</h4>
<?= $this->Form->create(null, ['id' => 'explosiveForm', 'class' => 'master_form']); ?>
<div class="col-md-2"></div>
<div class="col-md-8">
    <div class="row">
        <div class="col-md-6">
            <label for="explosive-name" class="labelForm"><span class="compulsoryField">*</span> Explosive Name</label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="unit" class="labelForm"><span class="compulsoryField">*</span> Explosive Unit</label>
        </div>
        <div class="col-md-6">
