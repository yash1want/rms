...
<h4 class="card-title bg-primary text-white masterHeading">Add New MCP Deposit</h4>
...
<div class="col-md-8">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="deposit-sn" class="labelForm"> Deposit Sn</label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="ts-comtx" class="labelForm"> Ts Comtx Dataeposit Name </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="deposit" class="labelForm"> Deposit Number </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="block" class="labelForm"> Block Number </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="strke" class="labelForm"> Strike Length </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="amount" class="labelForm"> Dip Amount </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="direction" class="labelForm"> Dip Direction </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="width" class="labelForm"> Width </label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="depth" class="labelForm"> Depth </label>
        </div>
        <div class="col-md-6">
