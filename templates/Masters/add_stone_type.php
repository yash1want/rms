...
<h4 class="card-title bg-primary text-white masterHeading">Add New Stone Type</h4>
<?= $this->Form->create(null, ['id' => 'stoneTypeForm', 'class' => 'master_form']); ?>
<div class="col-md-2"></div>
<div class="col-md-8">
    <div class="row">
        <div class="col-md-6">
            <label for="stone-def" class="labelForm"><span class="compulsoryField">*</span> Stone Def</label>
        </div>
        <div class="col-md-6">
