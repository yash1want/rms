...
<h4 class="card-title bg-primary text-white masterHeading">Add New Rock</h4>
<?= $this->Form->create(null, ['id' => 'rockForm', 'class' => 'master_form']); ?>
<div class="col-md-2"></div>
<div class="col-md-8">
    <div class="row">
        <div class="col-md-6">
            <label for="rock-code" class="labelForm"><span class="compulsoryField">*</span> Rock Code</label>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <label for="rock-name" class="labelForm"><span class="compulsoryField">*</span> Rock Name</label>
        </div>
        <div class="col-md-6">
